...
-}
serializeToOnelineTwilogJson : Bool -> Twilog -> Json.Encode.Value
serializeToOnelineTwilogJson setAlgoliaObjectID twilog =
    Json.Encode.object <|
        List.concat
            ...
            , if setAlgoliaObjectID then
                [ ( "objectID", Json.Encode.string twilog.idStr ) ]
