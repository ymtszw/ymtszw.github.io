module ExternalHtml exposing (Metadata, decoder, extractInlineTextFromHtml, getMetadata)
...
getMetadata : String -> DataSource.DataSource Metadata
getMetadata url =
...
htmlMetadataParser meta str =
    ...
    Html.Parser.runDocument str
        |> Result.mapError (List.map (\deadEnd -> Markdown.deadEndToString deadEnd ++ "\n\n" ++ showErrorLine deadEnd) >> String.join "\n\n")
